...
## Earnings-day event-entry bias

This variant breaks the trigger axis from its parent: instead of reacting to filings/disclosure drift on a daily-rebalance cadence, it only enters on the same-day an earnings announcement is released, targeting a ~10-day hold before exit. Cited basis: Quanter Lab's 20-window sealed backtest (2006-2025) found the classic post-earnings-announcement-drift (PEAD) book nets -0.5%/yr in large caps, while entering ON the earnings-announcement day itself nets +2.2%/yr, peaking at a 10-day hold before fading. Position count is trimmed to 3 (event-clustered rather than always-on) and take-profit widened to 6% to let the 10-day hold play out.
